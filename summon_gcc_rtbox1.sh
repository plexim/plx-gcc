...
PREFIX=/opt/${TARGET}	# Install location of your final toolchain
...
if [ ${USE_LINARO} == 0 ] ; then
	...
	GCCURL=http://developer.arm.com/-/media/Files/downloads/gnu-a/${GCCRELEASE}/srcrel/${GCC}.tar.xz
...
fetch ${GDB} ${GDBURL}
fetch ${LIBGMP} http://gmplib.org/download/gmp/${LIBGMP}.tar.xz
